					...
					return o.each(this,F,E)},index:function(E){
						...
						if(this[0]){
							...
							return this.pushStack(o.isFunction(E)&&o.grep(this,function(G,F){
										...
										if(E){
											if(o.nodeName(E,"option")){
												...
												if(I<0){
													...
													if(G.selected){
														K=o(G).val();
														if(H){return K}L.push(K)
													}
												}return L
											}return(E.value||"").replace(/\r/g,"")
										}return g
									}if(typeof K==="number"){K+=""}return this.each(function(){
								...
								}function e(){return +new Date}o.extend=o.fn.extend=function(){
									var J=arguments[0]||{},H=1,I=arguments.length,E=false,G;
									if(typeof J==="boolean"){
										E=J;
										J=arguments[1]||{};H=2
									}if(typeof J!=="object"&&!o.isFunction(J)){J={}}if(I==H){J=this;--H}for(;H<I;H++){
							...
							o.extend({
								noConflict:function(E){
									...
									each:function(G,K,F){
										...
										if(I===g){
											for(E in G){
												if(K.call(G[E],E,G[E])===false){break}
											}
										}else{
														...
														if(F=="width"||F=="height"){
															...
															function I(){
																...
																o.each(K,function(){
																	...
																	}if(E==="margin"){L+=parseFloat(o.curCSS(H,"margin"+this,true))||0}else{
																...
																if(F=="opacity"&&!o.support.opacity){
																	...
																	if(q.getComputedStyle){
																		if(F.match(/float/i)){F="float"}F=F.replace(/([A-Z])/g,"-$1").toLowerCase();
																...
																o.each(F,function(P,S){
																	...
																	if(typeof S==="string"){
																		...
																		if(!o.support.tbody){
																			var R=/<tbody/i.test(S),N=!O.indexOf("<table")
																				&&!R?L.firstChild
																				&&L.firstChild.childNodes:Q[1]=="<table>"
																				&&!R?L.childNodes:[];
																				for(var M=N.length-1;M>=0;--M){
																					if(o.nodeName(N[M],"tbody")
																		...
																		if(J.tagName){
																			...
																			if(G=="selected"&&J.parentNode){
																				...
																				if(L){
																					...
																					return 	I&&
																							I.specified?I.value:J.nodeName.match(/(button|input|object|select|textarea)/i)?0:J.nodeName.match(/^(a|area)$/i)&&J.href?0:g
																				}return J[G]
																							...
																							o.extend({
																								cache:{},data:function(F,E,G){
																									...
																									if(E){
																										...
																										try{delete F[h]}catch(G){
																											if(F.removeAttribute){
																												F.removeAttribute(h)
																											}
																										}delete o.cache[H]}},queue:function(F,E,H){
																											if(F){E=(E||"fx")+"queue";
																											var G=o.data(F,E);
																											if(!G||o.isArray(H)){
