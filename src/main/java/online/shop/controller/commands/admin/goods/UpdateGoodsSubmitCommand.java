...
public class UpdateGoodsSubmitCommand extends CommandExecuter {
    private static final Logger logger = Logger.getLogger(UpdateGoodsSubmitCommand.class);
    ...
    public String performExecute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(errors.hasErrors()){
            ...
            request.getRequestDispatcher(PagesPaths.GOODS_UPDATE_PAGE).forward(request, response);
